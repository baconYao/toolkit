...
func TestTools_PushJSONToRemote(t *testing.T) {
	...
	_, _, err := testTools.PushJSONToRemote("http://example.come/some/path", foo, client)
	if err != nil {
...
var slugTests = []struct {
	...
	{name: "chinese string", s: "你好嗎?", expected: "", errorExpected: true},
	{name: "chinese string and roman characters", s: "hello world 你好嗎?", expected: "hello-world", errorExpected: false},
}
...
func TestTools_DownloadStaticFile(t *testing.T) {
	...
	testTool.DownloadStaticFile(rr, req, "./testdata/img.png", "hello.png")
	...
	if res.Header["Content-Disposition"][0] != "attachment; filename=\"hello.png\"" {
...
func TestTools_ReadJSON(t *testing.T) {
	...
	for _, e := range jsonTests {
		...
		// declare a varaible to read the decoded json into
...
func TestTools_ErrorJSON(t *testing.T) {
	...
	if err != nil {
		t.Error("receive error when decoding JSON", err)
	}
